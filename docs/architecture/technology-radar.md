...
|-----------|--------|---------------|----------|
| Express.js | Inconsistent patterns | → NestJS or Fastify | Q2 2024 |
| Jenkins | Maintenance burden | → GitHub Actions | Q3 2024 |
| Ansible | Replaced by Terraform | → Terraform modules | Complete |
| MongoDB | Operational complexity | → PostgreSQL | Q4 2024 |
| Jaeger | Consolidating on Tempo | → Tempo + OTel | Q2 2024 |
| Docker Compose (prod) | Not production-grade | → Kubernetes | Complete |
| Webpack | Slow builds | → Vite (portal) | Q2 2024 |
| Moment.js | Deprecated, large bundle | → date-fns | Q1 2024 |
...
|------|----------|-----------|
| 2024-01 | Adopt OpenTelemetry | Vendor-neutral, unified observability |
| 2024-01 | Trial Karpenter | Better scaling, cost optimization |
